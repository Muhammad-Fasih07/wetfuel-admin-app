    ...
    >
      ...
      <IconButton size="medium">
        <Badge badgeContent={4} color="error">
          <NotificationsIcon sx={{ fontSize: 22, color: "#6b7280" }} />
        </Badge>
      </IconButton>

      <IconButton size="medium" component={Link} href="/settings">
        <SettingsIcon sx={{ fontSize: 22, color: "#6b7280" }} />
      </IconButton>
      ...
      >
        ...
        <Box sx={{ display: { xs: "none", md: "block" } }}>
          <Typography sx={{ fontSize: "0.8rem", fontWeight: 600, color: "#2b2b2b", lineHeight: 1.2 }}>
            {user?.name || "Super Admin"}
          </Typography>
          <Typography sx={{ fontSize: "0.65rem", color: "#887b6a", lineHeight: 1.2 }}>
      ...
      >
        ...
        <MenuItem onClick={handleCloseMenu} component={Link} href="/settings">
          <PersonIcon sx={{ fontSize: 18, mr: 1.5, color: "#6b7280" }} />
          <Typography sx={{ fontSize: "0.875rem" }}>Profile</Typography>
        </MenuItem>
        <MenuItem onClick={handleCloseMenu} component={Link} href="/settings">
          <SettingsIcon sx={{ fontSize: 18, mr: 1.5, color: "#6b7280" }} />
