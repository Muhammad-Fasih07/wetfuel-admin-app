    ...
    <Box>
      <Box sx={{ display: "flex", alignItems: "center", gap: 3, mb: 4 }}>
        <Box sx={{ position: "relative" }}>
          ...
          <Box sx={{ position: "absolute", bottom: 0, right: 0, width: 26, height: 26, borderRadius: "50%", backgroundColor: "#ce1c1a", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", border: "2px solid white" }}>
            <EditIcon sx={{ fontSize: 12, color: "white" }} />
          </Box>
        </Box>
        <Box>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>Super Admin</Typography>
          <Typography variant="body2" sx={{ color: "#887b6a" }}>admin@wetfuel.com</Typography>
        </Box>
      </Box>
